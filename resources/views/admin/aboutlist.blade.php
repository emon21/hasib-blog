                            ...
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-body">
                                        <h4 class="" style="margin-top:25px;font-size:20px;">About List</h4>
                                        <a href="{{ url('admin/about') }}" class="btn btn-info pull-right mt-1" style="margin-top:-42px;font-size:16px;">Add Data</a>
