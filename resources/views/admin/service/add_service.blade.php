                                ...
                                <div class="col-sm-12">
                                    <div class="panel panel-primary">
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" action="{{ url('admin/service/service_insert') }}" method="POST" enctype="multipart/form-data">
                                            @csrf                                            
                                            <div class="form-group">
                                                    <label class="col-md-2 control-label">Service Name</label>
                                                    <div class="col-md-10">
                                                        <input type="text" name="service_name" class="form-control" placeholder="Enter Your Service Name...">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control note-editable panel-body" rows="5" name="service_desc" placeholder="Enter Your Service Description...!!"></textarea>
                                                    </div>
                                                </div>
