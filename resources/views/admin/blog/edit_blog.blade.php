                               ...
                               <div class="col-sm-12">
                                   <div class="panel panel-primary">
                                       <div class="panel-body">
                                           ...
                                           <form class="form-horizontal" action="{{ url('admin/blog/blogupdate') }}" method="POST" enctype="multipart/form-data">
                                           @csrf
                                           <input type="hidden" name="blog_id" value="{{ $bloglist->id }}">
                                           ...
                                           <div class="form-group">
                                                   ...
                                                   <div class="col-md-10">
                                                       <input type="text" name="blog_name" value="{{ $bloglist->blog_name }}" class="form-control" placeholder="Enter Your Blog Name...">
                                                   </div>
                                               </div>
                                               ...
                                               <div class="form-group">
                                                   ...
                                                   <div class="col-md-10">
                                                       <textarea class="form-control note-editable panel-body" rows="5" name="blog_desc" placeholder="Enter Your Blog Description...!!">{{ $bloglist->blog_message }}</textarea>
                                                   </div>
                                               </div>
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <div class="col-md-10">
                                                       ...
                                                       <img src="{{ asset('/storage/blog') }}/{{ $bloglist->blog_picture }}" width="150" height="85">
